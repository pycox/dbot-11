...
def main(key, com, url):
    try:
        ...
        response = requests.post(
            url="https://bbinsurance.wd1.myworkdayjobs.com/wday/cxs/bbinsurance/Careers_Europe/jobs",
                        ...
                        for post in items:
                            ...
                            data.append(
                                [
                                    ...
                                    com,
                                    location,
                                    f"https://bbinsurance.wd1.myworkdayjobs.com/en-US/Careers_Europe{link}",
                                ]
                            )
                except:
                    continue
