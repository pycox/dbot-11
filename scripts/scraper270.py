...
#         driver.find_element(
#             By.CSS_SELECTOR, '#job_openings > div[data-testid="row"] > div > div'
#         )
...
def main(key, com, url):
    try:
        ...
        response = requests.post(
            url="https://turo.wd12.myworkdayjobs.com/wday/cxs/turo/Turo_careers/jobs",
                        ...
                        for post in items:
                            ...
                            data.append(
                                [
                                    ...
                                    com,
                                    location,
                                    f"https://turo.wd12.myworkdayjobs.com/en-US/Turo_careers{link}",
                                ]
                            )
                except:
                    continue
