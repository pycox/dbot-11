...
#             items = driver.find_element(By.CSS_SELECTOR, "li.css-1q2dra3")
...
def main(key, com, url):
    try:
        ...
        response = requests.post(
            url="https://wd1.myworkdaysite.com/wday/cxs/ssctech/SSCTechnologies/jobs",
                        ...
                        for post in items:
                            ...
                            data.append(
                                [
                                    ...
                                    com,
                                    location,
                                    f"https://harbourvest.wd5.myworkdayjobs.com/en-US/HVP{link}",
                                ]
                            )
                except:
                    continue
