...
def main(key, com, url):
    ...
    try:
        ...
        driver.execute_script(
            ...
            driver.find_element(By.CSS_SELECTOR, "#whr_embed_hook"),
        )
        ...
        tmp = driver.find_elements(
            By.XPATH, "//p[contains(text(), 'No positions available')]"
        )
        ...
        driver.find_element(By.CSS_SELECTOR, "ul.whr-items li.whr-item")
