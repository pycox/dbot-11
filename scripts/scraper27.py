...
def main(key, com, url):
    ...
    try:
        driver.get("https://hungerrush.applytojob.com/apply")

        time.sleep(8)

        try:
            driver.find_element(By.CSS_SELECTOR, "button.allow").click()
        ...
        driver.find_element(By.CSS_SELECTOR, "li.list-group-item")
