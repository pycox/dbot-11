...
#         driver.find_elements(By.CSS_SELECTOR, "li.css-1q2dra3")
...
def main(key, com, url):
    try:
        ...
        response = requests.post(
            url="https://isg.wd3.myworkdayjobs.com/wday/cxs/isg/ISG/jobs",
                        ...
                        for post in items:
                            ...
                            data.append(
                                [
                                    ...
                                    com,
                                    location,
                                    f"https://isg.wd3.myworkdayjobs.com/en-US/ISG{link}",
                                ]
                            )
                except:
                    continue
